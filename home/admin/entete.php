        ...
        <div id="conteneur">
            <div id="logo">
                <p> 
                    ...
                    <a href="index.php"><img src="../media/<?php echo $_SESSION['profil'] ?>" id="profil_utilisateur" alt="profil"> </a><span id="infos_utilisateur"><?php echo $_SESSION['nom'].' '.$_SESSION['prenom'] ?></span>
...
<div id="menu">
    <div>
        <nav>
            <ul>
                <li> <a href="enregistrement.php"><img src="../logo/carre-plus.svg" alt="ajouter" class="icon_menu_element"> Enregistrement</a> </li>
                <li><a href="rapport.php"><img src="../logo/budget-des-taches-de-la-liste-de-controle.svg" alt="ajouter" class="icon_menu_element"> Rapport</a></li>
                <li><a href="recherche.php"><img src="../logo/recherche-de-membres.svg" alt="ajouter" class="icon_menu_element"> Recherche</a></li>
                <li><a href="recherche_precis.php"><img src="../logo/recherche-de-membres.svg" alt="ajouter" class="icon_menu_element"> Recherche précise</a></li>
                <li><a href="solicitation_joueur.php"><img src="../logo/recherche-de-membres.svg" alt="ajouter" class="icon_menu_element"> Solicitations </a></li>
                <li><a href="comptes.php"><img src="../logo/utilisateur.svg" alt="ajouter" class="icon_menu_element"> Comptes</a></li>
