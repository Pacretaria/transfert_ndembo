...
<div id="menu">
    <div>
        <nav>
            <ul>
                <li> <a href="competition.php"> <img src="../logo/carre-plus.svg" alt="ajouter" class="icon_menu_element"> Compétition</a> </li>
                <li> <a href="recherche.php"> <img src="../logo/carre-plus.svg" alt="ajouter" class="icon_menu_element"> Performances</a> </li>
