                            ...
                            $date_actuel = date('Y');
                                ...
                                if(!empty($age) and (!empty($age_maximum))){
                                    ...
                                    if (($age_maximum_filtrer <= $date_naissance) && ($age_minimum_filtrer >= $date_naissance )) {
                                        ?>
                                        <tr>
                                            <td><a href="voir_profil_joueur.php?joueur=<?php echo $donnees_joueurs['reference'] ?>"><img src="media/<?php echo $donnees_joueurs['profil'] ?>" alt="profil" class="profil_joueurs_precis"> <p> <?php echo $donnees_joueurs['nom'].' '.$donnees_joueurs['prenom'] ?> <br><span> <?php echo $donnees_joueurs['position'] ?> </span> </p></a></td>
