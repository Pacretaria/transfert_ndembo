    ...
    <body>
        <form action="" method="post">
            ...
            <div>
                ...
                <div>
                    <label for="mail">Adresse Email ou Téléphone </label>
                ...
                <div>
                    ...
                    <button id="affiche_password"> <img src="../logo/vue_blache.svg" alt="bouton_view_passe" id="bouton_view_passe"> </button>
                </div>
                ...
                <div>
                    <a href="../candidature.php" id="redirection"> Créer un Compte </a>
