            ...
            if (isset($_POST['bouton_envoi'])) {
                ...
                if (isset($_POST['pied'],$_POST['sexe'],$_POST['manager'],$_POST['contact'],$_POST['contact_manager'])) {
                    ...
                    if ($nbr_verification == 0) {
                        ...
                        $enregistrement_jouer->execute(array($nom,$postnom,$prenom,$age,$taille,$position,$club,$pied,$_SESSION['reference'],$sexe,' ',$manager,$contact_manager,$contact,$reference,date('Y-m-d'),$heure,'user.jpg'));
